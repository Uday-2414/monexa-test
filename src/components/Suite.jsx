        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              At the heart of MONEXA lies{" "}
              <span className="font-bold text-blue-600">MONA</span> (Medical
              Optimized Neural Assistant), connecting multiple AI engines for
              complete diagnostic support.
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
              ...
              <div className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-blue-400 transform hover:scale-105 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    Multi-modality imaging AI for X-rays, CT scans, MRIs, and
                    ultrasounds with precision diagnostics.
                  </p>
              ...
              {/* MONA-X */}
              <div className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-green-400 transform hover:scale-105 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    A clinical intelligence system designed to support decision-making across radiology, pathology, Specialities and critical care with real-time multimodal insights.
                  </p>
              ...
              {/* MONA-COSMO */}
              <div className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-purple-400 transform hover:scale-105 overflow-hidden md:col-span-2 md:max-w-md md:mx-auto">
                ...
                <div className="relative z-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-fuchsia-500 rounded-2xl flex items-center justify-center text-4xl mb-6 shadow-lg transform group-hover:rotate-6 transition-transform duration-500">
                    🚀
                  </div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-3">
                    MONA-COSMO
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    Autonomous clinical intelligence system built for
                    communication-denied environments, enabling remote missions
                    and future Mars and lunar habitat medical operations.
                  </p>
