      ...
      <div className="max-w-7xl mx-auto px-2 py-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Empowering healthcare systems worldwide with AI-driven diagnostic
              support. MONA bridges the gap between technology and care,
              ensuring every patient gets timely and reliable diagnostics.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 pt-3 mb-3">
          ...
          <div className="flex justify-center gap-6">
            <a
              href="#"
              className="group w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gradient-to-br hover:from-blue-500 hover:to-cyan-500 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 shadow-lg"
            >
              <svg
            ...
            <a
              href="#"
              className="group w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gradient-to-br hover:from-gray-700 hover:to-gray-900 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 shadow-lg"
            >
              <svg
                className="w-6 h-6 text-gray-300 group-hover:text-white transition-colors"
                fill="currentColor"
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M18.244 2H21.5l-7.72 8.813L23 22h-7.078l-5.543-7.003L4.97 22H1.7l8.26-9.434L1 2h7.166l5.06 6.58L18.244 2zm-1.1 17.326h1.961L7.01 4.59H4.935l12.21 14.736z" />
              </svg>
            </a>

            <a
              href="#"
              className="group w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gradient-to-br hover:from-red-500 hover:to-red-700 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 shadow-lg"
            >
              <svg
                className="w-6 h-6 text-gray-300 group-hover:text-white transition-colors"
                fill="currentColor"
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 <span className="text-white font-semibold">MONEXA</span>. All
            rights reserved. | Revolutionizing Healthcare with AI
          </p>
        </div>
      </div>
    </footer>
