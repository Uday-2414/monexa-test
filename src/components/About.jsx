 ...
 <div className="bg-white py-24 px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-5xl font-bold text-gray-900 mb-6">Why MONEXA?</h2>
            <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
              Healthcare faces an urgent crisis - too few specialists, rising workloads, and unequal access. 
              <span className="font-semibold text-blue-600"> MONEXA's mission</span> is to empower healthcare systems 
              worldwide with AI-driven diagnostic support, ensuring every patient gets timely and reliable care.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            ...
            <div className="group relative bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-red-100">
              ...
              <div className="text-4xl font-bold text-red-600 mb-3">1:100,000</div>
              <p className="text-gray-700 font-medium mb-2">Radiologist shortage in India</p>
              <p className="text-sm text-gray-600">Only 1 radiologist available per 100,000 people</p>
            ...
            <div className="group relative bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-purple-100">
              ...
              <p className="text-gray-700 font-medium mb-2">Increased workload pressure</p>
              <p className="text-sm text-gray-600">Specialists facing burnout and diagnostic delays</p>
            ...
            <div className="group relative bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-blue-100">
              ...
              <p className="text-gray-700 font-medium mb-2">Global population underserved</p>
              <p className="text-sm text-gray-600">Billions lack access to quality diagnostic care</p>
          ...
          <div className="text-center mt-16">
            <p className="text-2xl text-gray-800 font-medium mb-6">
              AI-powered support for <span className="text-blue-600 font-bold">every diagnosis</span>, 
