...
import { Users, Linkedin, Award, Heart, Lightbulb, Target, Sparkles } from 'lucide-react';
  ...
  const values = [
    {
      ...
      title: "Patient-First",
      description: "Every algorithm we build prioritizes patient safety and clinical outcomes above all else."
    },
    {
      icon: <Lightbulb className="w-8 h-8" />,
      title: "Explainable AI",
      description: "Transparency in every decision. Our models provide clear, interpretable insights clinicians can trust."
    },
    {
      icon: <Target className="w-8 h-8" />,
      title: "Evidence-Based",
      description: "Validated through rigorous clinical trials and peer-reviewed research across diverse populations."
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-cyan-50 to-teal-50 overflow-hidden">
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto">
          <div 
            id="vision-card"
            data-animate
            className={`bg-white rounded-3xl shadow-2xl p-12 border border-gray-100 relative overflow-hidden ${isVisible['vision-card'] ? 'animate-fadeInScale' : 'opacity-0'}`}
          >
            ...
            <div className="relative flex items-start gap-6">
              ...
              <div className={isVisible['vision-card'] ? 'animate-slideInRight' : 'opacity-0'}>
                ...
                <p className="text-lg text-gray-700 leading-relaxed" style={{fontFamily: 'Inter, sans-serif'}}>
                  We envision a world where every clinician has access to intelligent decision support that enhances their expertise rather than replacing it. MONA EARTH represents our commitment to democratizing advanced medical AI, ensuring that cutting-edge diagnostic tools are accessible, interpretable, and trustworthy across healthcare systems globally. Our mission extends beyond technology—we're building a future where AI and human insight work in harmony to improve patient outcomes at scale.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <div 
            id="values-title"
            data-animate
            className={`text-center mb-12 ${isVisible['values-title'] ? 'animate-fadeInUp' : 'opacity-0'}`}
          >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((value, idx) => (
              <div 
                ...
                id={`value-${idx}`}
                data-animate
                className={`bg-white rounded-2xl p-8 shadow-lg border border-gray-100 card-hover relative overflow-hidden group ${isVisible[`value-${idx}`] ? 'animate-fadeInUp' : 'opacity-0'}`}
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div 
            id="founders-title"
            data-animate
            className={`text-center mb-16 ${isVisible['founders-title'] ? 'animate-fadeInUp' : 'opacity-0'}`}
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4" style={{fontFamily: 'Poppins, sans-serif'}}>
              Leadership Team
            </h2>
            <p className="text-lg text-gray-600" style={{fontFamily: 'Inter, sans-serif'}}>
              Decades of combined expertise in AI, medicine, and healthcare technology
            </p>
            <div className="flex items-center justify-center gap-3 mt-6">
              <div className="h-1 w-20 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full" />
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {founders.map((founder, idx) => (
              <div 
                ...
                id={`founder-${idx}`}
                data-animate
                className={`group bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-700 ${isVisible[`founder-${idx}`] ? 'animate-fadeInScale' : 'opacity-0'}`}
              ...
              >
                <div className="relative overflow-hidden image-reveal">
                  ...
                  {/* Floating Badge */}
                  <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-semibold text-blue-600 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-2 group-hover:translate-y-0" style={{fontFamily: 'Inter, sans-serif'}}>
                    Leader
                  </div>
                </div>
                ...
                <div className="p-8 relative">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2 relative z-10" style={{fontFamily: 'Poppins, sans-serif'}}>
                    {founder.name}
                  </h3>
                  <p className="text-blue-600 font-semibold mb-4 relative z-10" style={{fontFamily: 'Inter, sans-serif'}}>
                    {founder.role}
                  </p>
                  <p className="text-gray-600 leading-relaxed mb-6 relative z-10" style={{fontFamily: 'Inter, sans-serif'}}>
                    {founder.bio}
                  </p>
                  <a 
      ...
      <section className="py-20 px-6 relative">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div 
            id="advisors-title"
            data-animate
            className={`text-center mb-16 ${isVisible['advisors-title'] ? 'animate-fadeInUp' : 'opacity-0'}`}
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4" style={{fontFamily: 'Poppins, sans-serif'}}>
              Trusted Partners
            </h2>
            <p className="text-lg text-gray-600" style={{fontFamily: 'Inter, sans-serif'}}>
              Collaborating with world-leading medical institutions and research centers
            </p>
            <div className="flex items-center justify-center gap-3 mt-6">
              <div className="h-1 w-20 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full" />
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {advisors.map((advisor, idx) => (
              <div 
                ...
                id={`advisor-${idx}`}
                data-animate
                className={`bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 text-center group relative overflow-hidden ${isVisible[`advisor-${idx}`] ? 'animate-rotateIn' : 'opacity-0'}`}
              ...
              >
                ...
                <div className="relative">
                  <div className="w-20 h-20 bg-gradient-to-br from-blue-600 to-cyan-500 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-lg group-hover:shadow-2xl" style={{fontFamily: 'Poppins, sans-serif'}}>
                    {advisor.logo}
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2" style={{fontFamily: 'Poppins, sans-serif'}}>
                    {advisor.name}
                  </h3>
                  <p className="text-sm text-blue-600 font-medium" style={{fontFamily: 'Inter, sans-serif'}}>
                    {advisor.type}
                  </p>
                </div>
              </div>
      ...
      <section className="py-20 px-6">
        <div 
          id="cta-section"
          data-animate
          className={`max-w-4xl mx-auto rounded-3xl p-12 text-center text-white shadow-2xl relative overflow-hidden ${isVisible['cta-section'] ? 'animate-fadeInScale' : 'opacity-0'}`}
        >
          {/* Animated Gradient Background */}
          <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-600 bg-size-200 animate-gradient" style={{backgroundSize: '200% 200%', animation: 'gradient-shift 5s ease infinite'}} />
          ...
          <div className="absolute bottom-10 left-1/4 w-5 h-5 bg-white/25 rounded-full animate-float" style={{animationDelay: '2s'}} />
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl mb-8 opacity-90" style={{fontFamily: 'Inter, sans-serif'}}>
              We're always looking for talented individuals passionate about transforming healthcare through AI
            </p>
            <button className="bg-white text-blue-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105" style={{fontFamily: 'Inter, sans-serif'}}>
              View Open Positions →
            </button>
          </div>
        </div>
